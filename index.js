...
const SYSTEM_PROMPT = `তুমি হলে "DEVE EFAJ -WhatsApp AI" — একজন বন্ধু এবং সাহায্যকারী।
...
// ── State ──
let logs      = ['🚀 DEVE EFAJ -WhatsApp AI starting up...'];
...
app.get('/', (_req, res) => {
    ...
    const formBlock = (waConnected || waStarting) ? '' : `
        <div class="card">
            ...
            উদাহরণঃ <code>8801912268262</code></p>
            <div id="waForm">
...
<title>DEVE EFAJ -WhatsApp AI</title>
...
<div class="header">
  <div class="logo">DEVE EFAJ -WhatsApp AI</div>
  <div>
    <div class="title">DEVE EFAJ -WhatsApp AI</div>
    <div class="subtitle">⚡ DEVE EFAJ -WhatsApp AI ⚡</div>
  </div>
</div>
...
<div class="footer">
  <div class="dev">『 DEVE EFAJ』</div>
  <a href="https://t.me/websdeveloper01" target="_blank" rel="noopener">📩 t.me/websdeveloper01</a>
  <div class="tag">DEVELOPED · DEVE EFAJ · POWERED BY RIYAD</div>
</div>
            ...
            if (imgPrompt) {
                ...
                try {
                    ...
                    await sock.sendMessage(jid, {
                        image: buffer,
                        caption: `🎨 "${imgPrompt}"\n\n— RIYAD THE AI\n👨‍💻 Dev: 『 DEVE EFAJ 』 t.me/websdeveloper01`,
                    });
